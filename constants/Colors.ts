...
const primaryOrange = '#FF7F00'; // Vibrant orange accent
const secondaryOrange = '#FFA500'; // Lighter orange for gradients
const sophisticatedDark = '#0A0A0F'; // Deep, sophisticated dark background
const cardDarkBackground = '#1A1A24'; // Slightly lighter dark for cards
const cleanWhiteText = '#FFFFFF'; // Primary text color
const subtleGreyText = '#A0A0B8'; // Secondary text color
const subtleBorder = '#2A2A3A'; // Subtle border color
const deepShadow = '#000000'; // Shadow for depth

// Light mode (for system compatibility)
const lightBackground = '#F5F5F7';
const lightCardBackground = '#FFFFFF';
const lightTextPrimary = '#1A1A1A';
const lightTextSecondary = '#6B6B7B';
const lightBorder = '#E0E0E8';
...
export const Colors = {
  ...
  dark: {
    text: cleanWhiteText,
    textSecondary: subtleGreyText,
    background: sophisticatedDark,
    tint: primaryOrange,
    icon: subtleGreyText,
    tabIconDefault: subtleGreyText,
    tabIconSelected: primaryOrange,
    card: cardDarkBackground,
    border: subtleBorder,
    primary: primaryOrange,
    secondary: secondaryOrange,
    success: '#34D399',
...
export const tintColorLight = primaryOrange;
export const tintColorDark = primaryOrange;
...
export const borderColor = "#2A2A3A80";
